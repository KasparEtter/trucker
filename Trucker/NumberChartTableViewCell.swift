...
class NumberChartTableViewCell: UITableViewCell {
    ...
    @IBOutlet weak var secondEntryText: UILabel!
    @IBOutlet weak var secondEntryValue: UILabel!
    @IBOutlet weak var secondEntryTitle: UILabel!
    
    // Static properties
    static let height : CGFloat = 110
    static let identifier = "NumberChartTableViewCell"
